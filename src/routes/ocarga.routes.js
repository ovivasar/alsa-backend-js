...
const router = Router();
const {obtenerTodasOCargas,obtenerTodasOCargasPlan,obtenerTodasOCargasPlanTransb,obtenerOCarga,crearOCarga,actualizarOCarga,eliminarOCarga, obtenerTodasOCargasPlanCrossTab, obtenerTodasOCargasPlanCrossTab2, obtenerTodasOCargasPlanCrossTab3} = require('../controllers/ocarga.controllers')
